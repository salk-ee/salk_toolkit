...
# %% auto 0
__all__ = ['estimate_legend_columns_horiz_naive', 'estimate_legend_columns_horiz', 'boxplot_vals', 'estimate_box_from_beta',
           'boxplot_manual', 'columns', 'stacked_columns', 'diff_columns', 'massplot', 'make_start_end', 'likert_bars',
...
def estimate_box_from_beta(row,beta_max_k=1000):
    ...
    # Calculate quantiles of corresponding beta distribution
