...
@stk_plot('maxdiff', data_format='longform', draws=True, n_facets=(1,2), priority=1, group_sizes=True)
...
# Also create a raw version for the same plot
stk_plot('maxdiff-raw', data_format="raw", n_facets=(1,2), priority=0)(maxdiff_manual)
