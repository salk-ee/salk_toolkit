...
# %% auto 0
__all__ = ['DataDescription', 'DataSpec', 'MergeSpec', 'FilterScalar', 'FilterRange', 'FilterCategories', 'FilterValue',
           'FilterSpec', 'SortSpec', 'ConvertResOption', 'ContTransformOption', 'AggFnOption', 'FileDesc', 'DataMeta',
           'hard_validate', 'soft_validate', 'SingleMergeSpec', 'smc_ensure_list', 'PlotDescriptor']
...
# %% ../nbs/06_validation.ipynb 17
SortSpec = Union[List[str], Dict[str, bool]]
ConvertResOption = Literal['continuous']
ContTransformOption = Literal[
    'center', 'zscore', '01range', 'proportion', 'softmax', 'softmax-ratio',
    'softmax-avgrank', 'ordered-avgrank', 'ordered-warf', 'ordered-top1',
    'ordered-bot1', 'ordered-topbot1', 'ordered-top2', 'ordered-top3'
]
...
class PlotDescriptor(PBase):
    ...
    # Main parameters
    plot: str  # Registered plot type (see 03_plots.ipynb)
