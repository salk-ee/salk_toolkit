...
# %% auto 0
__all__ = ['streamlit_fn_factory', 'translate_pot', 'translate_dashboard_fn', 'translate_dashboard']
...
# %% ../nbs/11_commands.ipynb 6
#| eval: false
# Run explorer app
run_explorer = streamlit_fn_factory('./explorer.py',os.getcwd())
